...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_weights', default='/home/pliu/code/copy_modify_beit/save_result_3_train+val_pre_sub1_lr_down/checkpoint-99.pth', type=str, help="Path to pretrained weights to evaluate.")
    ...
    parser.add_argument('--lr', type=float, default=4, metavar='LR', help='learning rate (absolute lr)')
    ...
    parser.add_argument('--data_path', default='/home/pliu/code/copy_modify_beit/dataset_ASD_test/', type=str)
    parser.add_argument('--num_workers', default=10, type=int, help='Number of data loading workers per GPU.')
    parser.add_argument('--val_freq', default=1, type=int, help="Epoch frequency for validation.")
    parser.add_argument('--output_dir', default="/home/pliu/code/copy_modify_beit/test_save_result/", help='Path to save logs and checkpoints')
